...
os.environ.setdefault("ASSEMBLER_ARCH", "sm120")
...
def build_g2s_source(*, use_expect=True, phase_poll=False,
                     fence_chain=False, units=1, use_ushf_count=False):
    ...
    lines += [
        ...
        "    #def_label(datadone)",
        "    LDS.64 {R10,R11}, [RZ+UR10];[1:7:{0,2}:5:1]",
