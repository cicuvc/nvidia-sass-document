#!/usr/bin/env python3
"""Query the extracted sm_120 SASS ISA DB (sm120.json).
...
Reads sm120.json next to the repo root by default. Stdlib only.
"""
import argparse
import json
import re
...
DEFAULT_DB = Path(__file__).resolve().parent.parent / "sm120.json"
