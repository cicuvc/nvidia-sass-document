...
This is distinct from `MEMBAR` (`notes/membar.md`): MEMBAR orders the *generic*
...
**tensormap proxy** ↔ generic uses `UTMACCTL` (`notes/utmacctl.md`). Both are
...
- Contrast `fence.proxy.tensormap` → `UTMACCTL.IV` (`notes/utmacctl.md`): the two
