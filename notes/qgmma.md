...
Warpgroup-level async tensor core operation for 8-bit floating point types (e4m3/e5m2). Uses the same GMMA architecture as HGMMA — see `notes/wgmma.md` and `notes/hgmma.md` for sync model, accumulator collector, and GMMA scoreboard details.
...
Same GMMA layout as HGMMA (`notes/hgmma.md`), with QGMMA-specific opcode:
