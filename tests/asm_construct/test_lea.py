...
#fn lea_test(out<64>) {
    ...
    SEL R4, RZ, 0x1, !P0;[7:7:{}:5:1]
    STG.E desc[UR4][R6.64+0x28], R4;[7:1:{0}:1:0]
    ...
    STG.E desc[UR4][R6.64+0x2C], R2;[7:1:{0}:1:0]
    ...
    STG.E desc[UR4][R6.64+0x34], R2;[7:1:{0}:1:0]
    ...
    STG.E desc[UR4][R6.64+0x3C], R2;[7:1:{0}:1:0]
    ...
    STG.E desc[UR4][R6.64+0x44], R2;[7:1:{0}:1:0]
    ...
    STG.E desc[UR4][R6.64+0x4C], R2;[7:1:{0}:1:0]
